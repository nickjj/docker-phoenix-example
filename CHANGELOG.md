...
- Update `phoenix_live_view` to `1.0.5`
- Update `phoenix` to `1.7.20`
- Update `postgrex` to `0.20.0`
- Update `swoosh` to `1.17.10`
...
- Update `phoenix_html` to `4.2.1`
- Update `phoenix_live_view` to `1.0.9`
